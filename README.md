...
Sentiment analysis is sensibly influencing artificial intelligence development and it is widely used in a variety of applications, including human-machine interaction, automatic driving, security intelligence, and so on. Criminals, terrorists, and individuals used to exchange messages on the Internet in different formats (text, audio, image, or video) to reach their goals, recruit members, and disseminate their intentions, in order to commit an illegal act or cause harm or loss to others.
People generate a large amount of multimodal data with rich sentiment information every day using communication tools or social media platforms, such as Facebook, YouTube, and Twitter. Text format is an important mode of communication in our daily lives; it expresses feelings through words, phrases, and relationships. With the introduction of transfer learning models like BERT, text sentiment analysis has made significant progress in recent years.
Although, textual information remains limited, especially when reporting about feelings. In some cases, judging accurately emotions based on text information alone could be difficult. It is why the textual modality is frequently accompanied by its complementary, the audio modality. Sentiment information can also be found in the audio modality but is much more difficult to handle (due to noise, confusion, and unpredictability) than simple text data. It is distinguished by changes in voice qualities such as pitch, energy, vocal effort, loudness, and other frequency-related measurements. The relation between text and audio modalities can provide even more comprehensive information and capture more emotional characteristics.
Moreover, monitoring social media exchanged communications has traditionally required security officers to visually detect the presence of security threats (such as the presence of weapons) by observing exchanged images and video messages on social media websites and making quick judgments based on them. One of the most effective ways to overcome the limitations of manual analysis is to process the exchanged images or video streams using deep learning object detection algorithms to automate threat detection. Naturally, videos are sequences of images. This is what we are looking forward by this research proposal.
The majority of state-of-the-art image classification systems employ different types of deep learning approaches, CNN-based object detection systems have been applied to a variety of image processing applications recently. That is why there is a high demand for building efficient CNN architectures capable of predicting crimes. Several architectures are both computationally efficient and accurate: the R-CNN Family, SSD, and YOLO.
